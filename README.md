# Genetic (Evolutionary) algorithm for process scheduling
This repository is an implementation of modified genetic algorithm, which we call Evolutionary Algorithm. It is adapted to solve P||C<sub>max</sub> problem. Besides the implementation of the algorithm, this repo contains utlilities that help test it, such as benchmark generator or simple greedy algorithm
...
Graph comparing the performance of the evolutionary algorithm versus the greedy approach and the optimal values. 
